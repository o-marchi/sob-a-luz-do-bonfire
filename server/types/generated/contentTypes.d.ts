...
export interface ApiCampaignCampaign extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Component<'shared.campaign-user', true>;
...
export interface ApiSecretCodeSecretCode extends Struct.CollectionTypeSchema {
  collectionName: 'secret_codes';
  info: {
    displayName: 'Secret Code';
    pluralName: 'secret-codes';
    singularName: 'secret-code';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    global_name: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::secret-code.secret-code': ApiSecretCodeSecretCode;
